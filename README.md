...
[![Comparison](https://img.shields.io/badge/🔹_Comparison-패턴_선택_기준-4A90D9?style=for-the-badge)](./architecture-comparison/01-layered-vs-hexagonal-vs-clean.md)
...
| [redis-deep-dive](https://github.com/dev-book-lab/redis-deep-dive) | Redis 내부 구조, 캐싱 패턴 | Ch3-03(KafkaPublisher Adapter 패턴), Ch5-05(MSA 서비스 간 이벤트 통신) |
